...
resource "aws_lb_target_group" "main" {
  ...
  protocol         = lookup(var.target_groups["count.index"], "backend_protocol", null) != null ? upper(lookup(var.target_groups["backend_protocol"])) : null
  protocol_version = lookup(var.target_groups[count.index], "protocol_version", null) != null ? upper(lookup(var.target_groups["protocol_version"])) : null
